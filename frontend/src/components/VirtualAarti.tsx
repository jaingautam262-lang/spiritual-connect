...
export default function VirtualAarti() {
  ...
  const [bellRipples, setBellRipples] = useState(0);
  const [conchWaves, setConchWaves] = useState(0);
    ...
    <div className="max-w-2xl mx-auto">
      <div className="ornamental-border rounded-2xl p-6 md:p-10 bg-card text-center">
        ...
        <p className="font-body text-sm text-muted-foreground mb-8">
          Light the diya, ring the bell, and blow the conch to perform your virtual aarti
        </p>
            ...
            <button
              ...
              style={{
                background: dyiaLit
                  ...
                  : 'oklch(0.93 0.02 75)',
                boxShadow: dyiaLit ? '0 0 40px oklch(0.78 0.14 75 / 0.6), 0 0 80px oklch(0.68 0.20 48 / 0.3)' : 'none',
              ...
              {dyiaLit ? (
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(to top, oklch(0.68 0.20 48), oklch(0.88 0.18 75), oklch(0.95 0.05 80))',
                    }}
                  />
                </div>
              ) : (
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              <button
                ...
                style={{
                  background: bellRinging ? 'oklch(0.78 0.14 75 / 0.2)' : 'oklch(0.93 0.02 75)',
                  border: '2px solid oklch(0.78 0.14 75 / 0.3)',
                  animation: bellRinging ? 'bell-shake 0.5s ease-in-out' : 'none',
                }}
              >
                <span className="text-5xl" style={{ display: 'inline-block', animation: bellRinging ? 'bell-shake 0.3s ease-in-out 3' : 'none' }}>🔔</span>
              </button>
              {bellRinging && (
                <div
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              <button
                ...
                className="w-28 h-28 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
                style={{
                  background: conchBlowing ? 'oklch(0.55 0.12 200 / 0.15)' : 'oklch(0.93 0.02 75)',
                  border: '2px solid oklch(0.78 0.14 75 / 0.3)',
                }}
              >
                <span className="text-5xl">🐚</span>
              ...
              {conchBlowing && (
                <>
                  <div className="absolute inset-0 rounded-full animate-ripple pointer-events-none" style={{ border: '2px solid oklch(0.55 0.12 200 / 0.4)' }} />
                  <div className="absolute inset-0 rounded-full pointer-events-none" style={{ border: '2px solid oklch(0.55 0.12 200 / 0.3)', animation: 'ripple 1s ease-out 0.3s forwards' }} />
                </>
              )}
            </div>
            <p className="font-heading font-semibold text-sm" style={{ color: 'oklch(0.35 0.12 25)' }}>
        ...
        {dyiaLit && (
          <div
            ...
            style={{ background: 'oklch(0.78 0.14 75 / 0.08)', borderColor: 'oklch(0.78 0.14 75 / 0.2)' }}
          >
            <p className="font-heading text-sm italic" style={{ color: 'oklch(0.45 0.12 35)' }}>
