  ...
  return (
    <div>
      <div className="relative w-full overflow-hidden" style={{ minHeight: '280px' }}>
        <img src="/assets/generated/numerology-banner.dim_1200x400.png" alt="Numerology" className="w-full h-72 object-cover" />
      ...
      <div className="container mx-auto px-4 py-10">
        <Tabs defaultValue="personal">
          <TabsList className="w-full max-w-lg mx-auto grid grid-cols-3 mb-8 h-auto p-1 rounded-xl"
          ...
          <TabsContent value="personal"><PersonalNumerology /></TabsContent>
          <TabsContent value="mobile"><MobileNumerology /></TabsContent>
          <TabsContent value="compatibility"><NameCompatibility /></TabsContent>
        </Tabs>
      </div>
    </div>
  );
