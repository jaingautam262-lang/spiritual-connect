  ...
  return (
    <div>
      <div className="relative w-full overflow-hidden" style={{ minHeight: '280px' }}>
        <img src="/assets/generated/panchang-banner.dim_1200x400.png" alt="Horoscope & Panchang" className="w-full h-72 object-cover" />
      ...
      <div className="container mx-auto px-4 py-10">
        <Tabs defaultValue="panchang">
          <TabsList className="w-full max-w-2xl mx-auto grid grid-cols-4 mb-8 h-auto p-1 rounded-xl"
          ...
          <TabsContent value="panchang"><DailyPanchang /></TabsContent>
          <TabsContent value="vrat"><VratCalendar /></TabsContent>
          <TabsContent value="rashifal"><Rashifal /></TabsContent>
          <TabsContent value="kundli"><KundliGenerator /></TabsContent>
        </Tabs>
      </div>
    </div>
  );
