...
export function useRechargeWallet() {
  ...
  return useMutation({
    ...
    onSuccess: (_, vars) => {
      queryClient.invalidateQueries({ queryKey: ['walletBalance', vars.userId.toString()] });
      queryClient.invalidateQueries({ queryKey: ['walletTransactions', vars.userId.toString()] });
    },
  });
}
...
export function useCreateDevotionalContent() {
  ...
  return useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['devotionalContents'] }),
  });
}
...
export function useSaveVirtualTempleConfig() {
  ...
  return useMutation({
    ...
    onSuccess: (_, vars) => {
      queryClient.invalidateQueries({ queryKey: ['virtualTempleConfig', vars.userId.toString()] });
    },
  });
}
...
export function useAddVratKatha() {
  ...
  return useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['vratKathas'] }),
  });
}
...
export function useAddHolyBookEntry() {
  ...
  return useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['holyBookEntries'] }),
  });
}
