...
export default function VirtualChadhava() {
  ...
  const handleSubmit = async () => {
    if (!identity) {
      toast.error("Please login to make offerings");
      return;
    }
    if (!templeId) {
    ...
    return (
      <div className="max-w-lg mx-auto text-center py-12">
        ...
        <p className="font-body text-muted-foreground mb-6">
          Your virtual chadhava has been offered at the temple. May the divine
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="ornamental-border rounded-2xl p-6 md:p-8 bg-card">
        ...
        <div className="mb-6">
          <p
            className="block text-sm font-heading font-semibold mb-3"
            style={{ color: "oklch(0.35 0.12 25)" }}
          >
            Select Offerings
          </p>
