...
export default function SahasranamSangrah() {
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div
              ...
              data-ocid="sangrah.detail.panel"
            >
              <h3
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.18 0.08 22) 0%, oklch(0.26 0.14 38) 60%, oklch(0.22 0.10 30) 100%)",
        }}
      >
        <div className="relative max-w-4xl mx-auto">
          <motion.div
          ...
          >
            सभी देवी-देवताओं के पवित्र सहस्रनाम — एक स्थान पर
          </motion.p>
          <motion.div
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          >
            ...
            >
              ✨ {sahasranams.length}+ सहस्रनाम उपलब्ध
            </Badge>
          </motion.div>
        </div>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div className="relative flex-1">
            ...
            <Input
              placeholder={
                isListening ? "सुन रहा हूँ..." : "देवता या सहस्रनाम का नाम लिखें..."
              }
              value={searchQuery}
              ...
              style={{
                ...
                outline: isListening
                  ? "2px solid oklch(0.65 0.22 30 / 0.4)"
                  : undefined,
              }}
              data-ocid="sangrah.search_input"
            />
            {voiceSupported && (
              <button
                type="button"
                ...
                data-ocid="sangrah.voice_search_button"
              >
                {isListening ? (
        ...
        {isListening && (
          <motion.div
            ...
            style={{
              background: "oklch(0.65 0.22 30 / 0.10)",
          ...
          >
            ...
            <span
              ...
              style={{ color: "oklch(0.50 0.18 30)" }}
            >
              🎤 सुन रहा हूँ... बोलें
            </span>
          </motion.div>
        ...
        {voiceError && (
          <div
            ...
            data-ocid="sangrah.voice_error_state"
          >
            ⚠️ {voiceError}
          </div>
        )}
        ...
        {/* Cards Grid */}
        {filtered.length === 0 ? (
          <div className="text-center py-20" data-ocid="sangrah.empty_state">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((sahasranam, idx) => (
              <motion.div
                ...
                onClick={() => setSelectedSahasranam(sahasranam)}
                data-ocid={`sangrah.item.${idx + 1}`}
              >
                <div
                ...
                <div className="p-5">
                  ...
                  >
                    <span>🕉️</span>
                    <span>सहस्रनाम — १०००+ पावन नाम</span>
                  </div>
