        ...
        <div className="space-y-4">
          ...
          {results.length === 0 ? (
            <div className="text-center py-6 font-body text-muted-foreground">
              No better alternatives found. Your name already has a favorable
              number!
            </div>
          ) : (
