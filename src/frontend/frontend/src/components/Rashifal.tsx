    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="font-body text-sm text-muted-foreground">
          Select your zodiac sign for predictions
        </p>
      </div>
      ...
      <div className="ornamental-border rounded-2xl p-6 bg-card mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="font-body text-sm text-muted-foreground">
              {rashi.dates} • {rashi.element} • {rashi.rulingPlanet}
            </p>
          </div>
        </div>
        ...
        <Tabs defaultValue="daily">
          <TabsList className="mb-4">
            <TabsTrigger value="daily" className="font-heading text-xs">
              Daily
            </TabsTrigger>
            <TabsTrigger value="weekly" className="font-heading text-xs">
              Weekly
            </TabsTrigger>
            <TabsTrigger value="yearly" className="font-heading text-xs">
              Yearly
            </TabsTrigger>
          </TabsList>
