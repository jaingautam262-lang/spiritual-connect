...
const STATIC_CONTENT: DevotionalContent[] = [
  ...
  {
    id: "dc10",
    title: "Krishna Bhajan - Achyutam Keshavam",
    deity: "Krishna",
    contentType: "bhajan",
    language: "Sanskrit",
    createdAt: BigInt(0),
...
export default function DevotionalLibrary() {
  ...
  const filtered = displayContents.filter(
    (c) =>
  ...
  const byType = (type: string) =>
    filtered.filter((c) => c.contentType === type);
  ...
  return (
    <div>
      ...
      >
        <img
          src="/assets/generated/devotional-banner.dim_1200x400.png"
          alt="Devotional Library"
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <Tabs defaultValue="bhajan">
          <TabsList
            className="w-full max-w-lg mx-auto grid grid-cols-4 mb-8 h-auto p-1 rounded-xl"
            ...
            >
              <div>
                ...
                <p className="text-sm font-body text-muted-foreground">
                  {selectedContent.deity} • {selectedContent.language}
                </p>
              </div>
              <button
                type="button"
